...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        dx_vocab, dW_vocab, db_vocab = temporal_affine_backward(grad, cache_vocab)
        if self.cell_type == 'rnn':
            dx_rnn, dh0, dWx, dWh, db = rnn_backward(dx_vocab, cache_rnn)
        elif self.cell_type == 'lstm':
            dx_rnn, dh0, dWx, dWh, db = lstm_backward(dx_vocab, cache_rnn)
